...
function Hero() {
  return (
    <header className="hero min-h-[90vh] flex gap-8 flex-col lg:flex-row justify-center lg:justify-around items-center text-black">
      <div className="lg:order-2 bg-gradient-to-br from-red-600 to-orange-600 rounded-full shadow-xl">
        <div></div>
        <img
          src={cart}
          alt=""
          className="w-full max-w-[200px] xl:max-w-[280px]"
        />
      </div>
      <div>
        <h1 className="text-[16vw] sm:text-8xl lg:text-[7rem] xl:text-[8rem] font-black tracking-wide leading-none">
          Marke
